...
async def create_book(
    ...
    return await LibraryService(db, token_payload).create_new_book(book.dict(exclude_unset=True))
...
async def patch_book(
    ...
    return await LibraryService(db, token_payload).update_book(book_id, book.dict(exclude_unset=True))
